...
import com.rajk2007.novacast.databinding.FragmentPluginDetailsBinding
import com.rajk2007.novacast.plugins.PluginManager
import com.rajk2007.novacast.plugins.VotingApi.canVote
import com.rajk2007.novacast.plugins.VotingApi.getVotes
import com.rajk2007.novacast.plugins.VotingApi.hasVoted
import com.rajk2007.novacast.plugins.VotingApi.vote
import com.rajk2007.novacast.R
import com.rajk2007.novacast.ui.BaseBottomSheetDialogFragment
    ...
    override fun onBindingCreated(binding: FragmentPluginDetailsBinding) {
        ...
        binding.apply {
            ...
            if (data.isDownloaded) {
                ...
                val plugin =
                    (PluginManager.urlPlugins[metadata.url] ?: PluginManager.plugins[metadata.url]) as? com.rajk2007.novacast.plugins.Plugin
