...
import com.rajk2007.novacast.APIHolder
import com.rajk2007.novacast.CommonActivity.showToast
import com.rajk2007.novacast.DubStatus
import com.rajk2007.novacast.LoadResponse
import com.rajk2007.novacast.MainActivity.Companion.afterPluginsLoadedEvent
import com.rajk2007.novacast.R
import com.rajk2007.novacast.Score
import com.rajk2007.novacast.SearchResponse
import com.rajk2007.novacast.base64Encode
import com.rajk2007.novacast.databinding.FragmentResultBinding
import com.rajk2007.novacast.databinding.FragmentResultSwipeBinding
import com.rajk2007.novacast.databinding.ResultRecommendationsBinding
import com.rajk2007.novacast.databinding.ResultSyncBinding
...
import com.rajk2007.novacast.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.rajk2007.novacast.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.rajk2007.novacast.ui.download.DownloadButtonSetup
import com.rajk2007.novacast.ui.player.CSPlayerEvent
import com.rajk2007.novacast.ui.player.FullScreenPlayer
import com.rajk2007.novacast.ui.player.source_priority.QualityProfileDialog
import com.rajk2007.novacast.ui.quicksearch.QuickSearchFragment
import com.rajk2007.novacast.ui.result.ResultFragment.bindLogo
import com.rajk2007.novacast.ui.result.ResultFragment.getStoredData
import com.rajk2007.novacast.ui.result.ResultFragment.updateUIEvent
import com.rajk2007.novacast.ui.search.SearchAdapter
import com.rajk2007.novacast.ui.search.SearchHelper
...
import com.rajk2007.novacast.utils.AppContextUtils.openBrowser
...
import com.rajk2007.novacast.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.rajk2007.novacast.utils.SingleSelectionHelper.showBottomDialogInstant
...
import com.rajk2007.novacast.utils.UIHelper.populateChips
import com.rajk2007.novacast.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.rajk2007.novacast.utils.UIHelper.setListViewHeightBasedOnItems
...
import com.rajk2007.novacast.utils.downloader.VideoDownloadManager
import com.rajk2007.novacast.utils.getImageFromDrawable
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.rajk2007.novacast.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.rajk2007.novacast.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                    ...
                    binding?.apply {
                        ...
                        resultShare.setOnClickListener {
                            try {
                                ...
                                val redirectUrl =
                                    "https://renovacast.github.io/csredirect?redirectto=$encodedUri"
                                i.type = "text/plain"
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.rajk2007.novacast.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
