...
import com.rajk2007.novacast.CommonActivity.keyEventListener
import com.rajk2007.novacast.CommonActivity.playerEventListener
import com.rajk2007.novacast.CommonActivity.screenHeightWithOrientation
import com.rajk2007.novacast.CommonActivity.screenWidthWithOrientation
...
import com.rajk2007.novacast.databinding.PlayerCustomLayoutBinding
import com.rajk2007.novacast.databinding.SpeedDialogBinding
import com.rajk2007.novacast.databinding.SubtitleOffsetBinding
import com.rajk2007.novacast.mvvm.logError
import com.rajk2007.novacast.mvvm.safe
import com.rajk2007.novacast.ui.player.GeneratorPlayer.Companion.subsProvidersIsActive
...
import com.rajk2007.novacast.utils.AppContextUtils.isUsingMobileData
...
import com.rajk2007.novacast.utils.UIHelper.getNavigationBarHeight
import com.rajk2007.novacast.utils.UIHelper.getStatusBarHeight
import com.rajk2007.novacast.utils.UIHelper.hideSystemUI
import com.rajk2007.novacast.utils.UIHelper.popCurrentPage
import com.rajk2007.novacast.utils.UIHelper.showSystemUI
import com.rajk2007.novacast.utils.UIHelper.toPx
import com.rajk2007.novacast.utils.UserPreferenceDelegate
import com.rajk2007.novacast.utils.Vector2
...
//        player_video_title_rez?.isGone = isGone
    ...
    private fun handleKeyEvent(event: KeyEvent, hasNavigated: Boolean): Boolean {
        ...
        when (keyCode) {
            ...
            // netflix capture back and hide ~monke
            // This is removed due to inconsistent behavior on A36 vs A22, see https://github.com/renovacast/novacast/issues/1804
