...
import com.rajk2007.novacast.databinding.FragmentHomeHeadBinding
import com.rajk2007.novacast.databinding.FragmentHomeHeadTvBinding
...
import com.rajk2007.novacast.ui.account.AccountHelper.showAccountEditDialog
...
import com.rajk2007.novacast.utils.SingleSelectionHelper.showOptionSelectStringRes
import com.rajk2007.novacast.utils.UIHelper.fixPaddingStatusbarMargin
import com.rajk2007.novacast.utils.UIHelper.fixPaddingStatusbarView
        ...
        private val resumeAdapter = ResumeItemAdapter(
            ...
            removeCallback = { v ->
                try {
                    ...
                    // Copy pasted from https://github.com/renovacast/novacast/pull/1658/files
                    builder.apply {
