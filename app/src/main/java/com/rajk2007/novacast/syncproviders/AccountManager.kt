...
abstract class AccountManager {
    companion object {
        ...
        const val APP_STRING = "novacastapp"
        const val APP_STRING_REPO = "novacastrepo"
        const val APP_STRING_PLAYER = "novacastplayer"

        // Instantly start the search given a query
        const val APP_STRING_SEARCH = "novacastsearch"

        // Instantly resume watching a show
        const val APP_STRING_RESUME_WATCHING = "novacastcontinuewatching"
