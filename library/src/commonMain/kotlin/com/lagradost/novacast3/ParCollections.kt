...
@Deprecated(
    ...
    replaceWith = ReplaceWith("amap(f)", "com.rajk2007.novacast.amap"),
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("amapIndexed(f)", "com.rajk2007.novacast.amapIndexed"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("runAllAsync(transforms)", "com.rajk2007.novacast.runAllAsync"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
fun <R> argamap(
